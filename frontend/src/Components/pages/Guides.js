...
export default function Guides() {
  ...
  return (
    <div className="conatiner-fluid" style={{ backgroundColor:"white", backgroundSize: 'cover',height:'100%' }}>
      
  
    {/* Add other styling for your outer container as needed */}
    <>
    <div className="button-container-fluid" style={{textAlign:'center'}}>
    ...
    {selectedContent && (
          ...
          <div className="pic" style={{ position: 'absolute', left: '110px', top: '230px' }}>
        <img src="https://wallpapers.com/images/hd/passport-pictures-huctncquz2fzv1ht.jpg" alt="Your" style={{ width: '300px', height: '300px',borderRadius:'6px' }} />
        <br></br>
        <br></br>
        ...
        <img src="https://aadhaarcard.co.in/wp-content/uploads/2023/04/aadhaar-card.webp"alt="your" style={{ width: '300px', height: '300px',borderRadius:'6px' }} />
        <br></br>
        <br></br>
        <h4><strong>Documents Required</strong></h4>
        <br></br>
        ...
        <img src="https://www.godigit.com/content/dam/godigit/directportal/en/contenthm/telangana-driving-licence.jpg"alt="your" style={{ width: '300px', height: '300px',borderRadius:'6px' }} />
        <br></br>
        <br></br>
        <h4><strong>Documents Required</strong></h4>
        <br></br>
        ...
        <div className="grid text-center">
            ...
            {selectedContent === "Voter ID" && (
             ...
             <div className="image-card" style={{ position: 'absolute', left: '110px', top: '220px' }}>
        <img src="https://5.imimg.com/data5/SELLER/Default/2023/7/326236311/DG/UC/NY/147613454/613b4fe5118d68e33daead1f-5f9ce9d6b395d08d26991e6e-voter-id-2x-min.jpg" alt="Your" style={{ width: '300px', height: '300px',borderRadius:'6px' }} />
        <br></br>
        <br></br>
        <h4><strong>Documents Required</strong></h4>
        <br></br>
        ...
        <div className="grid text-center">
             ...
             <div className="image-card" style={{ position: 'absolute', left: '110px', top: '220px' }}>
        <img src="https://mybillbook.in/blog/wp-content/uploads/2022/07/pan-card.png" alt="Your" style={{ width: '300px', height: '300px',borderRadius:'6px' }} />
        <br></br>
        <br></br>
