...
export default function About() 
{
 ...
 <div className="container-fluid" style={{ backgroundColor: "#FEECE2" }}>
  <div className="row h-40 align-items-center container-fluid">
...
<div className="row bg-dark p-3 text-white " style={{"height":"80%"}}>
  ...
  <h4 calssname="text-primary">Follow us</h4>
      <p><i class="fa-brands fa-instagram">instagram</i></p>
      <p><i class="fa-brands fa-twitter">twitter</i></p>
    <p><i class="fa-brands fa-facebook">facebook</i></p>
  </div>
  <div className="col sm-3 ">
  <h4 classname="text-danger">Contact us </h4>
      ...
      <p><i class="fa-solid fa-phone"></i>   6305836536</p>
  </div>
  </div>
