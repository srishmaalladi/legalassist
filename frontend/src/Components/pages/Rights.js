...
const Rights = () => {
  ...
  return (
    <>
<div  style={{"background-color":"#F9E8d9","display":"flex","flexDirection":"row","fontSize":"x-large" }}>
...
{activeDiv === 1  && <div className='conatiner-fluid md-6 sm-12 '><img src={equal} class="image-fluid" alt="srishma" style={{ maxWidth: '60%', maxHeight: '60%' }} /> <h1>Right to Equality (Articles 14 - 18)</h1> <p style={{"padding":"2%","fontFamily":"calligraphy","fontWeight":"bold"}}>"The right to equality provides for the equal treatment of everyone before the law, prevents discrimination on various grounds, treats everybody as equals in matters of public employment, and abolishes untouchability"</p>
<br/>
...
{activeDiv === 2 && <div className='conatiner-fluid md-6 sm-12'><img src={freedo} class="image-fluid" alt="..." style={{ maxWidth: '60%', maxHeight: '60%' }} /><h1>Right to Freedom (Articles 19 - 22)</h1>
...
{activeDiv === 3 && <div className='conatiner-fluid md-6 sm-12'><img src={cons} class="image-fluid" alt="..."  style={{ maxWidth: '60%', maxHeight: '60%' }} /><h1>Right to Constitutional Remedies</h1>
...
{activeDiv === 4 && <div className='conatiner-fluid md-6 sm-12'><img src={privacy} class="image-fluid" alt="..."  style={{ maxWidth: '60%', maxHeight: '60%' }} />
...
{activeDiv === 5 && <div className='conatiner-fluid md-6 sm-12'><img src={info} class="image-fluid" alt="..."  style={{ maxWidth: '60%', maxHeight: '60%' }} />
...
thirty days or 48 hours, as the case may be. 
        ...
        {activeDiv === 6 && <div className='conatiner-fluid md-6 sm-12'><img src={educ} class="image-fluid" alt="..."  style={{ maxWidth: '60%', maxHeight: '60%' }} />
...
<ul style={{"list-style-type":"disc"}}>
  ...
  <li>The Act also mandates that no kid is detained until class 8. It introduced the Continuous Comprehensive Evaluation (CCE) system in 2009 to have grade-appropriate learning outcomes in schools.</li>
        ...
        {activeDiv === 7 && <div className='conatiner-fluid md-6 sm-12'><img src={cultur} class="image-fluid max-image" alt="..." style={{ maxWidth: '60%', maxHeight: '60%' }} />
  ...
  <p>Article 30(2): The State shall not, when granting aid to educational institutions, discriminate against any educational institution on the ground that it is under the management of a minority, whether based on religion or language.</p>
        ...
        {activeDiv === 8 && <div className='conatiner-fluid md-6 sm-12'><img src={work} class="image-fluid" alt="..."/><h1>Right-to-Work Law</h1>
        <h1>Right to Work</h1>
